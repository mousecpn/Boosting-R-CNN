...
from mmdet.core.visualization import imshow_det_bboxes, imshow_det_bboxes_water
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        nargs='+',
        default=['DefaultFormatBundle', 'Normalize', 'Collect', 'RandomFlip', 'Pad'],
